      ...
      <div class="col-md-4">
        ...
        <div class="form-group">
          ...
          <input
            ...
            type="text"
            name="description"
            value=${context.content.description}
          />
        </div>
      </div>
      <div class="col-md-4">
        ...
        <div class="form-group">
          ...
          <input
            ...
            type="text"
            name="material"
            value=${context.content.material}
          />
        </div>
...
export async function editView(ctx, context) {
  ...
  context.container.querySelectorAll("input.form-control").forEach((i) =>
